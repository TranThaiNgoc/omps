...
//        dd($genrals_settings);
        ...
        return view('front.checkout', compact('shippingChage','selectedaddress', 'selectedstates', 'selectedcities', 'shippingcharge', 'cart_table', 'addresses', 'all_country', 'conversion_rate', 'sentfromlastpage','handling_charge','handing_charge_array','shipping_coupan'));
    }
