...
Route::group(['middleware' => ['auth','admin_access','switch_lang']], function () {
    ...
    Route::post('admin/handling/charge/store',"HandlingChargeController@store")->name('admin.handling.charge.store');
     ...
     Route::prefix('admin/shipping/charge/')->name('admin.shipping.charge.')->group(function () {
        // index page 
    ...
    Route::get('admin/shippingcoupan', 'ShippingCoupanController@index')->name('admin.shipping.coupan');
    Route::post('admin/shippingcoupan/update', 'ShippingCoupanController@update');
