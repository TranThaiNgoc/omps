<template>
    <div>
        ...
        <div :key="Math.random().toString(36).substring(7)"
            ...
            <div v-for="bestseller in bestseller" :key="Math.random().toString(36).substring(7)" class="item item-carousel">
                    ...
                    <div class="product">
                        ...
                        <div class="product-image">
                            <div class="image">
                                ...
                                <a href="#" :title="bestseller.name  &&  bestseller.name">
                                    
                                    <span v-if="bestseller.image">
                                        <img class="owl-lazy"
                                            :data-src="`/images//user/${bestseller.image}`" alt="product_image" />
                                    </span>
                        ...
                        <div class="product-info" :class="{'text-left' : rtl == false, 'text-right' : rtl == true}">
                            ...
                            <!-- <div v-if="bestseller.rating != 0" :class="{'float-left' : rtl == false, 'float-right' : rtl == true}">
