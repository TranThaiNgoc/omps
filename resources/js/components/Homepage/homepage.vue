<template>
    ...
    <div>
       ...
       <best-sellers v-if="!loadingforfeatured" :date="date" :lang="lang" :fallbacklang="fallbacklang" :login="logged_in" :guest_price="guest_price" :bestseller="bestseller" :products="featuredproducts"></best-sellers>
